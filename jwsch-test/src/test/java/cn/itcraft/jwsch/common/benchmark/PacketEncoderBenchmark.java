...
public class PacketEncoderBenchmark {
    ...
    private Packet packetWithTopic;
    private Packet packetWithLargeBody;
    ...
    @Setup(Level.Trial)
    public void setup() {
        channel = new EmbeddedChannel(new PacketEncoder());
        ...
        normalPacket = new Packet(normalHeader, normalBody);
        ...
        packetWithTopic = new Packet(topicHeader, topicBody);
        ...
        packetWithLargeBody = new Packet(largeHeader, largeBody);
    }
    ...
    public void benchmarkEncode_normalPacket() {
        channel.writeOutbound(normalPacket.retain());
    }

    @Benchmark
    public void benchmarkEncode_packetWithTopic() {
        channel.writeOutbound(packetWithTopic.retain());
    }

    @Benchmark
    public void benchmarkEncode_packetWithLargeBody() {
        channel.writeOutbound(packetWithLargeBody.retain());
    }
}
